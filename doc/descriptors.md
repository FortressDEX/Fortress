# Support for Output Descriptors in Fortress Core

Since Fortress Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `fort1...` for mainnet or `tfort1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Fortress's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Fortress Core wallets, a convenience function `combo` is
