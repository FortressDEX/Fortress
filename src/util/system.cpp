...
const char * const BITCOIN_CONF_FILENAME = "fortress.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Fortress";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Fortress";
#else
    // Unix
    return pathRet / ".fortress";
#endif
#endif
}
