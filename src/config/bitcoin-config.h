...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Fortress Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Fortress Core"
...
#define PACKAGE_BUGREPORT "https://github.com/fortress-project/fortress/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Fortress Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Fortress Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "fortress"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://fortress.org/"
