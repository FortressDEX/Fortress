...
"""Verify that starting fortress with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start fortress with -h for help text")
        ...
        self.log.info("Start fortress with -version for version information")
        ...
        self.log.info("Start fortressd with -fakearg to make sure it does not start")
