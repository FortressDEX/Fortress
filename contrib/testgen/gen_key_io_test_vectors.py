...
bech32_templates = [
  ...
  ('fort',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('fort',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('fort',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tfort',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tfort',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tfort',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rfort',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rfort',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rfort', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tfort',  17, 32, False, False, False),
  ('rfort',  3,  1, False, False, False),
  ('fort',   15, 41, False, False, False),
  ('tfort',  0, 16, False, False, False),
  ('rfort',  0, 32, True,  False, False),
  ('fort',   0, 16, True,  False, False),
  ('tfort',  0, 32, False, True,  False),
  ('rfort',  0, 20, False, False, True)
]
