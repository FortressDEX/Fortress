...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " fortress-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  fortress-tx [options] <hex-tx> [commands]  Update hex-encoded fortress transaction\n" +
            "or:     fortress-tx [options] -create [commands]   Create hex-encoded fortress transaction\n" +
            "\n";
